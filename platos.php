            ...
            <div class="table-responsive text-center">
                <table class="table table-bordered">
                    ...
                    <tbody id="myTable">
                        ...
                        include("php/obtenerplatos.php");
                        include("php/eliminarplato.php");
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm" method="post">
                            ...
                            <label> Descripción</label>
                            <div class="form-floating mb-3">
                                <textarea id="actuDescripcion" class="form-control" name="actuDescripcion" placeholder="Leave a comment here"></textarea>
                            </div>
                            <div class="mb-3">
